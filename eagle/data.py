...
def Split_Data_full_data(real_dataset_path:str,fake_dataset_path:str,train_val_test_ratio:tuple=(0,0,0)):
  ...
  X_train=np.concatenate((real_data_spectrogram,fake_data_spectrogram),axis=0)
  Y_train=np.concatenate((real_data_labels,fake_data_labels),axis=0)
